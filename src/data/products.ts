...
export const products: Product[] = [
  ...
  },
  {
   ...
   {
    id: "12",
    title: "SATMOLA Digestive Aam Papad (Pack of 3) 660gm | Dried Mango Papad After Meal Digestive Churan Goli | Aam Pacak Churan Candy",
    description: "Mango",
    price: 379,
   ...
   {
    id: "13",
    title: "GO DESi Popz Imli Pop, Tamarind & Jaggery Candy",
    description: "GO DESi Popz Imli Pop, Tamarind & Jaggery Candy, 50 Pieces, Tangy Imli, Imli Candy, 400 g",
    price: 250,
